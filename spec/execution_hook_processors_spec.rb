describe 'Execute Hook' do
  ...
  context 'before suite' do
    it 'should add custom message and screenshots from before suite' do
      ...
      expect(response.executionStatusResponse.executionResult.screenshots).to match_array ["before_suite"]
    end
  end
  ...
  context 'after suite' do
    it 'should add custom message and screenshots from after suite' do
      ...
      expect(response.executionStatusResponse.executionResult.screenshots).to match_array ["after_suite"]
    end
  end
  ...
  context 'before spec' do
    it 'should add custom message and screenshots from before spec' do
      ...
      expect(response.executionStatusResponse.executionResult.screenshots).to match_array ["before_spec"]
    end
  end
  ...
  context 'after spec' do
    it 'should add custom message and screenshots from after spec' do
      ...
      expect(response.executionStatusResponse.executionResult.screenshots).to match_array ["after_spec"]
    end
  end
  ...
  context 'before scenario' do
    it 'should add custom message and screenshots from before scenario' do
      ...
      expect(response.executionStatusResponse.executionResult.screenshots).to match_array ["before_scenario"]
    end
  end
  ...
  context 'after scenario' do
    it 'should add custom message and screenshots from after scenario' do
      ...
      expect(response.executionStatusResponse.executionResult.screenshots).to match_array ["after_scenario"]
    end
  end
  ...
  context 'before step' do
    it 'should add custom message and screenshots from before step' do
      ...
      expect(response.executionStatusResponse.executionResult.screenshots).to match_array ["before_step"]
    end
  end
  ...
  context 'after step' do
    it 'should add custom message and screenshots from after step' do
      ...
      expect(response.executionStatusResponse.executionResult.screenshots).to match_array ["after_step"]
    end
  end
